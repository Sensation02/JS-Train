...
function getDateDetails(date) {
  // Перевірка, чи є вхідне значення об'єктом Date,це можна зробити перевіривши чи є date.getTime по типу функція .
 ...
 *   resultDate: // Результат дати в форматі 'гггг-мм-дд'.
 * }
 */
function addDays(date, days) {
  ...
  // Збереження результату дати для виведення в форматі ISO.
  // Повертаємо об'єкт з початковою датою, кількістю доданих днів та результату дати.
...
function getFormattedTime(date) {
  ...
  // Повертаємо об'єкт з початковою датою та відформатованим часом.
  if (typeof date.getTime !== 'function') {
    return "Помилка: вхідне значення має бути об'єктом Date"
  } else {
    let inputDate = date.toISOString()
...
function getAge(birthDate) {
  // Перевірка, чи є вхідне значення об'єктом Date,це можна зробити перевіривши чи є birthDate.getTime по типу функція .
