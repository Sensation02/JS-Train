...
function findLastEvenNumber(arr) {
  ...
  } else if (arr.findLast((element) => element % 2 === 0)) {
    return (lastEvenNumber = arr.findLast((element) => element % 2 === 0))
  } else {
...
function getLastElementsSumAndPrint(arr, n) {
  ...
  let sum = lastElements.reduceRight((sum, item) => sum + item)
  lastElements.forEach((item) => console.log(item))
  return sum
}
...
function wordLengths(arr) {
  ...
  let lengthsArray = arr.map((item) => item.length)
  return lengthsArray
}
...
function findDuplicateElements(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let duplicateElements = arr.filter(
...
function capitalizeWords(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let capitalizedArray = arr.map((item) => {
...
function findLastNegativeNumberIndex(arr) {
  ...
  if (!Array.isArray(arr)) {
    ...
    let lastIndex = arr.findLastIndex((item) => item < 0)
    return lastIndex
  }
}
