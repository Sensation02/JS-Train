...
function calculateCircleArea(radius) {
  ...
  if (typeof radius !== 'number') {
    console.log('Помилка: Параметр radius повинен бути числом.')
    return null
  } else {
...
function findMinMax(numbers) {
  ...
  if (!Array.isArray(numbers)) {
    console.log('Помилка: Параметр numbers повинен бути масивом.')
    return null
  } else {
    let min = numbers[0]
    let max = numbers[0]
...
function calculateHypotenuse(a, b) {
  ...
  if (typeof a !== 'number' || typeof b !== 'number') {
    console.log('Помилка: Параметри a та b повинні бути числами.')
    return null
  } else {
...
// Завдання 7
/**
 * Функція `sumPositiveNumbers` обчислює суму додатних чисел у масиві.
 *
 * numbers - масив чисел.
 * Поверне: Сума додатних чисел.
 */
function sumPositiveNumbers(numbers) {
  ...
  // Повертаємо null, що свідчить про неможливість обробки вхідних даних.
  // Ініціалізуємо змінну для збереження суми додатних чисел.
  // Проходимо по всіх числах у масиві за допомогою циклу for.
  // Перевіряємо, чи є поточне число додатним, використовуючи Math.sign.
  // Якщо число додатне, додаємо його до суми.
  // Повертаємо суму додатних чисел.
  if (!Array.isArray(numbers)) {
...
function getFractionalPart(num) {
  ...
  if (typeof num !== 'number') {
    ...
    let roundedFractionalPart = Math.fround(fractionalPart)
...
function isTotalPriceExceedsMaxPrice(products, maxPrice) {
  ...
  // Додаємо ціну продукту до акумулятора.
  ...
  if (products instanceof Array === false) {
    ...
    let convertedTotalPrice = Math.fround(totalPrice)
    let convertedMaxPrice = Math.fround(maxPrice)
