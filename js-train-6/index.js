...
//Завдання 2. Створіть об'єкт personLarge який буде мати такі ж поля як person ,
...
function copyObject(obj) {
  // Використовуємо синтаксис деструктуризації {...person} для створення нового об'єкта з тими ж властивостями
...
function hasProperty(obj, property) {
  ...
  // Запишемо умову якщо властивість існує повертає текст Property ${property} exists,
