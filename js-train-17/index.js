...
function checkFlags(regex) {
  ...
  let flags = []
  regex.ignoreCase ? flags.push('ignoreCase') : flags.push('caseSensitive')
...
function checkRegexMethods(regex) {
  ...
  let methods = []
  regex.dotAll ? methods.push('dotAll') : methods.push('notDotAll')
  regex.multiline ? methods.push('multiline') : methods.push('notMultiline')
  regex.sticky ? methods.push('sticky') : methods.push('notSticky')
  return methods
}
